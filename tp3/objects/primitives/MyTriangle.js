...
export class MyTriangle extends CGFobject {
  ...
  initBuffers() {
    ...
    vec3.cross(
      ...
      [this.x3 - this.x1, this.y3 - this.y1, this.z3 - this.z1]
    );
    ...
    this.texCoords = [
      ...
      this.v1_v2,
      1,
      this.v3_v1 * this.cosv1_v2,
      1 - this.v3_v1 * this.sinv1_v2,
    ];
  ...
  updateTexCoords(length_s, length_t) {
    this.texCoords = [
      ...
      this.v1_v2 / length_s,
      1,
      (this.v3_v1 * this.cosv1_v2) / length_s,
      1 - (this.v3_v1 * this.sinv1_v2) / length_t,
    ];
